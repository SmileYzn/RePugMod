...
void CCvars::Load()
{
	...
	// Play Knife Round (0 Disable Knife Round, 1 Play Knife Round)
	this->m_KnifeRoundPlay = this->Register("pug_knife_round_play", "0");
...
cvar_t* CCvars::GetKnifeRoundPlay()
{
	return this->m_KnifeRoundPlay;
}
