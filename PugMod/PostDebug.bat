...
set "outputFile=..\Debug\pugmod_mm.dll"

set "copyPath1=C:\Files\Desktop\steamcmd\hlds\cstrike\addons\pugmod\dlls"
set "copyPath2=D:\Files\Desktop\steamcmd\hlds\cstrike\addons\pugmod\dlls"
