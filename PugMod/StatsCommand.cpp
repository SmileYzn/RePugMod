...
void CStatsCommand::TakeDamage(CBasePlayer* Player, entvars_t* pevInflictor, entvars_t* pevAttacker, float& flDamage, int bitsDamageType)
{
	if (g_pGameRules)
	{
		if (Player->IsPlayer())
...
bool CStatsCommand::HP(CBasePlayer* Player)
{
	if (g_pGameRules)
	{
		if (gPugMod.IsLive())
...
bool CStatsCommand::Damage(CBasePlayer* Player)
{
	if (g_pGameRules)
	{
		if (gPugMod.IsLive())
...
bool CStatsCommand::Received(CBasePlayer* Player)
{
	if (g_pGameRules)
	{
		if (gPugMod.IsLive())
...
bool CStatsCommand::Summary(CBasePlayer* Player)
{
	if (g_pGameRules)
	{
		if (gPugMod.IsLive())
